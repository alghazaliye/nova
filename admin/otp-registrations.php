...
<div class="box">
  ...
  <p>أُدمجت صفحة طلبات التسجيل (OTP) مع طلبات تسجيل البريد في صفحة واحدة. جاري التحويل...</p>
</div>
<script>
// تبويب الرسائل النصية في الصفحة الموحدة
setTimeout(() => { window.location.href = 'registrations.php?tab=phone'; }, 900);
</script>
</body>
</html>
