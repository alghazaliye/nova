...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1333: x0 => x0.load(),
      _1334: x0 => x0.remove(),
      _1335: x0 => x0.hasChildNodes(),
      _1336: (x0,x1) => x0.setSinkId(x1),
      _1337: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1338: x0 => globalThis.HTMLVideoElement(x0),
      _1339: x0 => x0.load(),
      _1340: x0 => x0.play(),
      _1341: x0 => x0.pause(),
      _1342: (x0,x1) => { x0.width = x1 },
      _1343: (x0,x1) => { x0.height = x1 },
      _1344: (x0,x1) => { x0.objectFit = x1 },
      _1345: (x0,x1) => { x0.src = x1 },
      _1347: (x0,x1) => { x0.autoplay = x1 },
      _1348: x0 => x0.style,
      _1349: x0 => x0.paused,
      _1357: (x0,x1) => x0.createElement(x1),
      _1363: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1364: x0 => globalThis.URL.revokeObjectURL(x0),
      _1365: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      ...
      _1368: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      _1382: (x0,x1) => x0.start(x1),
      _1383: (x0,x1) => x0.end(x1),
      ...
      _1393: x0 => ({audio: x0}),
      _1394: (x0,x1) => x0.getUserMedia(x1),
      _1395: x0 => x0.stop(),
      _1396: (x0,x1) => x0.removeTrack(x1),
      _1397: x0 => x0.close(),
      _1398: (x0,x1) => x0.warn(x1),
      _1399: x0 => x0.getSettings(),
      _1400: x0 => ({sampleRate: x0}),
      _1401: x0 => new AudioContext(x0),
      _1402: () => new AudioContext(),
      _1405: (x0,x1) => x0.connect(x1),
      _1406: (x0,x1) => x0.createMediaStreamSource(x1),
      ...
      _1409: (x0,x1) => x0.addModule(x1),
      _1410: x0 => ({parameterData: x0}),
      _1411: (x0,x1,x2) => new AudioWorkletNode(x0,x1,x2),
      _1412: x0 => ({name: x0}),
      _1413: (x0,x1) => x0.query(x1),
      _1414: x0 => x0.enumerateDevices(),
      _1419: x0 => x0.disconnect(),
      _1420: x0 => x0.stop(),
      _1421: (x0,x1,x2) => ({mimeType: x0,audioBitsPerSecond: x1,bitsPerSecond: x2}),
      _1422: (x0,x1) => new MediaRecorder(x0,x1),
      ...
      _1425: (x0,x1) => x0.start(x1),
      _1426: x0 => ({type: x0}),
      _1427: (x0,x1) => new Blob(x0,x1),
      _1428: (x0,x1) => globalThis.jsFixWebmDuration(x0,x1),
      _1429: x0 => x0.createAnalyser(),
      _1430: (x0,x1) => x0.getFloatFrequencyData(x1),
      _1431: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      _1432: x0 => x0.decode(),
      _1433: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1434: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1447: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1450: (x0,x1) => x0.item(x1),
      _1451: () => new FileReader(),
      _1453: (x0,x1) => x0.readAsArrayBuffer(x1),
      ...
      _1498: Object.is,
      _1499: o => o instanceof Array,
      _1500: (a, i) => a.push(i),
      _1504: a => a.pop(),
      _1505: (a, i) => a.splice(i, 1),
      _1506: (a, s) => a.join(s),
      _1507: (a, s, e) => a.slice(s, e),
      _1509: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1510: a => a.length,
      _1511: (a, l) => a.length = l,
      _1512: (a, i) => a[i],
      _1513: (a, i, v) => a[i] = v,
      _1515: o => {
      ...
      _1518: o => o instanceof Uint8Array,
      _1519: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1520: o => o instanceof Int8Array,
      _1521: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1522: o => o instanceof Uint8ClampedArray,
      _1523: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1524: o => o instanceof Uint16Array,
      _1525: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1526: o => o instanceof Int16Array,
      _1527: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1528: o => o instanceof Uint32Array,
      _1529: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1530: o => o instanceof Int32Array,
      _1531: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1533: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1534: o => o instanceof Float32Array,
      _1535: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1536: o => o instanceof Float64Array,
      _1537: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1538: (t, s) => t.set(s),
      _1539: l => new DataView(new ArrayBuffer(l)),
      _1540: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1542: o => o.buffer,
      _1543: o => o.byteOffset,
      _1544: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1545: (b, o) => new DataView(b, o),
      _1546: (b, o, l) => new DataView(b, o, l),
      _1547: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1548: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1549: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1550: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1551: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1552: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1553: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1554: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1555: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1556: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1557: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1558: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1561: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1562: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1563: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1564: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1565: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1566: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1579: (ms, c) =>
      ...
      _1586: (x0,x1) => x0.exec(x1),
      _1587: (x0,x1) => x0.test(x1),
      _1588: x0 => x0.pop(),
      _1590: o => o === undefined,
      _1592: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1594: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1595: o => o instanceof RegExp,
      _1596: (l, r) => l === r,
      _1597: o => o,
      _1598: o => o,
      _1599: o => o,
      ...
      _1601: o => o.length,
      _1603: (o, i) => o[i],
      _1604: f => f.dartFunction,
      _1605: () => ({}),
      _1606: () => [],
      _1608: () => globalThis,
      _1609: (constructor, args) => {
      ...
      _1611: (o, p) => o[p],
      _1612: (o, p, v) => o[p] = v,
      _1613: (o, m, a) => o[m].apply(o, a),
      _1615: o => String(o),
      _1616: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      ...
      _1620: o => [o],
      _1621: (o0, o1) => [o0, o1],
      _1622: (o0, o1, o2) => [o0, o1, o2],
      _1623: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1645: (o, p) => p in o,
      _1646: (o, p) => o[p],
      _1773: (x0,x1) => x0.replaceTrack(x1),
      ...
      _1899: x0 => x0.random(),
      _1900: (x0,x1) => x0.getRandomValues(x1),
      _1901: () => globalThis.crypto,
      _1902: () => globalThis.Math,
      _1908: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1911: Function.prototype.call.bind(Number.prototype.toString),
      _1912: Function.prototype.call.bind(BigInt.prototype.toString),
      ...
      _1935: x0 => x0.style,
      _1938: x0 => x0.src,
      _1939: (x0,x1) => { x0.src = x1 },
      _1940: x0 => x0.naturalWidth,
      _1941: x0 => x0.naturalHeight,
      _1957: x0 => x0.status,
      _1958: (x0,x1) => { x0.responseType = x1 },
      _1960: x0 => x0.response,
      _2009: (x0,x1) => { x0.responseType = x1 },
      _2010: x0 => x0.response,
      _2070: (x0,x1) => { x0.draggable = x1 },
      _2086: x0 => x0.style,
      _2099: (x0,x1) => { x0.oncancel = x1 },
      _2105: (x0,x1) => { x0.onchange = x1 },
      _2145: (x0,x1) => { x0.onerror = x1 },
      _2518: (x0,x1) => { x0.src = x1 },
      _2529: x0 => x0.width,
      _2531: x0 => x0.height,
      _2658: x0 => x0.videoWidth,
      _2659: x0 => x0.videoHeight,
      _2663: (x0,x1) => { x0.playsInline = x1 },
      _2688: x0 => x0.error,
      _2689: x0 => x0.src,
      _2690: (x0,x1) => { x0.src = x1 },
      _2692: (x0,x1) => { x0.srcObject = x1 },
      _2698: (x0,x1) => { x0.preload = x1 },
      _2699: x0 => x0.buffered,
      _2702: x0 => x0.currentTime,
      _2703: (x0,x1) => { x0.currentTime = x1 },
      _2704: x0 => x0.duration,
      _2709: (x0,x1) => { x0.playbackRate = x1 },
      _2716: (x0,x1) => { x0.autoplay = x1 },
      _2718: (x0,x1) => { x0.loop = x1 },
      _2720: (x0,x1) => { x0.controls = x1 },
      _2722: (x0,x1) => { x0.volume = x1 },
      _2724: (x0,x1) => { x0.muted = x1 },
      _2739: x0 => x0.code,
      _2740: x0 => x0.message,
      _2813: x0 => x0.length,
      ...
      _3317: (x0,x1) => { x0.src = x1 },
      _3319: (x0,x1) => { x0.type = x1 },
      _3337: (x0,x1) => { x0.charset = x1 },
      _3361: x0 => x0.width,
      _3362: (x0,x1) => { x0.width = x1 },
      _3363: x0 => x0.height,
      _3364: (x0,x1) => { x0.height = x1 },
      ...
      _4831: x0 => x0.track,
      _4964: x0 => x0.receiver,
      _4965: x0 => x0.track,
      _4966: x0 => x0.streams,
      _4967: x0 => x0.transceiver,
      _5806: x0 => x0.destination,
      _5810: x0 => x0.state,
      _5811: x0 => x0.audioWorklet,
      _5914: (x0,x1) => { x0.fftSize = x1 },
      _5915: x0 => x0.frequencyBinCount,
      _5917: (x0,x1) => { x0.minDecibels = x1 },
      _5919: (x0,x1) => { x0.maxDecibels = x1 },
      _5921: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      _6175: x0 => x0.port,
      _6314: x0 => x0.type,
      _6315: x0 => x0.target,
      _6355: x0 => x0.signal,
      _6367: x0 => x0.length,
      _6415: x0 => x0.firstChild,
      _6426: () => globalThis.document,
      _6506: x0 => x0.body,
      _6508: x0 => x0.head,
      _6838: x0 => x0.id,
      _6839: (x0,x1) => { x0.id = x1 },
      _6866: x0 => x0.children,
      _8185: x0 => x0.value,
      _8187: x0 => x0.done,
      _8357: x0 => x0.size,
      _8358: x0 => x0.type,
      ...
      _8371: x0 => x0.length,
      _8376: x0 => x0.result,
      _8745: x0 => x0.mimeType,
      _8746: x0 => x0.state,
      _8750: (x0,x1) => { x0.onstop = x1 },
      _8752: (x0,x1) => { x0.ondataavailable = x1 },
      _8777: x0 => x0.data,
      _8867: x0 => x0.url,
      _8869: x0 => x0.status,
