...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BJ: x0 => x0.body,
      BK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      ...
      DJ: (x0,x1) => x0.createElement(x1),
      DK: (x0,x1) => { x0.controls = x1 },
      ...
      EK: (x0,x1) => x0.removeAttribute(x1),
      ...
      QI: x0 => x0.status,
      QJ: (x0,x1) => { x0.srcObject = x1 },
      QK: (x0,x1) => { x0.enabled = x1 },
      QL: x0 => new Blob(x0),
      ...
      YI: x0 => x0.signal,
      YJ: x0 => new RTCPeerConnection(x0),
      ...
      dI: (x0,x1) => x0.setLocalDescription(x1),
      ...
      hI: (x0,x1,x2) => ({candidate: x0,sdpMid: x1,sdpMLineIndex: x2}),
      hJ: x0 => x0.streams,
      ...
      iI: (x0,x1) => x0.addIceCandidate(x1),
      iJ: x0 => x0.transceiver,
      iK: x0 => x0.click(),
      iL: x0 => x0.status,
      iM: x0 => x0.altKey,
      ...
      kI: (x0,x1) => x0.setRemoteDescription(x1),
      kJ: x0 => x0.track,
      kK: x0 => x0.children,
      ...
      lI: (x0,x1) => x0.createOffer(x1),
      lJ: x0 => x0.connectionState,
      lK: x0 => x0.firstChild,
      ...
      nI: (x0,x1,x2) => x0.addTrack(x1,x2),
      nJ: (x0,x1) => { x0.onicegatheringstatechange = x1 },
      ...
      qI: x0 => x0.getVideoTracks(),
      qJ: x0 => x0.sdpMLineIndex,
      qK: x0 => x0.name,
      ...
      uJ: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      yG: x0 => x0.maxWidth,
      yH: x0 => x0.document,
      yI: (x0,x1) => { x0.transform = x1 },
      yJ: x0 => x0.videoHeight,
      yK: (x0,x1) => { x0.src = x1 },
