...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BJ: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      BK: x0 => x0.response,
      BL: x0 => x0.ctrlKey,
      BM: (x0,x1,x2) => ({mimeType: x0,audioBitsPerSecond: x1,bitsPerSecond: x2}),
      BN: x0 => x0.geolocation,
      ...
      CM: (x0,x1) => new MediaRecorder(x0,x1),
      ...
      GL: (x0,x1) => { x0.volume = x1 },
      GM: (x0,x1) => x0.createMediaStreamSource(x1),
      ...
      HK: (x0,x1) => { x0.pointerEvents = x1 },
      HL: (x0,x1) => { x0.muted = x1 },
      HM: x0 => x0.createAnalyser(),
      ...
      JL: (x0,x1) => x0.start(x1),
      JM: (x0,x1) => { x0.smoothingTimeConstant = x1 },
      ...
      LK: x0 => x0.src,
      LL: x0 => x0.length,
      LM: (x0,x1) => { x0.onstop = x1 },
      LN: (x0,x1) => { x0.preload = x1 },
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      NK: x0 => globalThis.HTMLVideoElement(x0),
      NL: (x0,x1) => { x0.playbackRate = x1 },
      NM: (x0,x1) => new Blob(x0,x1),
      NN: (x0,x1) => x0.setSinkId(x1),
      ...
      OK: x0 => x0.load(),
      OL: x0 => x0.pause(),
      OM: x0 => globalThis.URL.createObjectURL(x0),
      ON: (x0,x1) => x0.querySelector(x1),
      ...
      PI: x0 => x0.status,
      PJ: x0 => x0.decode(),
      PK: (x0,x1) => { x0.objectFit = x1 },
      PL: x0 => x0.play(),
      PM: x0 => x0.arrayBuffer(),
      PN: (x0,x1) => x0.append(x1),
      ...
      SK: x0 => x0.style,
      SL: x0 => x0.load(),
      SM: (x0,x1) => { x0.ondataavailable = x1 },
      ...
      UK: (x0,x1) => { x0.src = x1 },
      UL: x0 => x0.message,
      UM: x0 => globalThis.MediaRecorder.isTypeSupported(x0),
      ...
      WK: x0 => x0.paused,
      WL: x0 => x0.error,
      WM: x0 => x0.channelCount,
      WN: (x0,x1) => { x0.oncancel = x1 },
      X: o => [o],
      XB: (t, s) => t.set(s),
      XC: (x0,x1) => x0.test(x1),
      ...
      YL: x0 => x0.videoHeight,
      YM: x0 => new AudioContext(x0),
      YN: x0 => x0.lastModified,
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      aL: (x0,x1) => { x0.playsInline = x1 },
      aM: x0 => x0.sampleRate,
      aN: (x0,x1) => x0.replaceChildren(x1),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      bM: x0 => x0.getSettings(),
      bN: (x0,x1,x2) => x0.setAttribute(x1,x2),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cI: (x0,x1) => x0.readAsArrayBuffer(x1),
      cJ: x0 => x0.naturalWidth,
      cK: x0 => x0.stopPropagation(),
      cL: (x0,x1) => { x0.autoplay = x1 },
      cM: x0 => x0.disconnect(),
      cN: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      d: (o, p) => o[p],
      ...
      dM: (x0,x1) => x0.removeTrack(x1),
      dN: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      fK: (x0,x1) => { x0.max = x1 },
      fL: (x0,x1) => { x0.border = x1 },
      fM: (x0,x1) => x0.warn(x1),
      fN: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      ...
      iL: (x0,x1) => x0.removeAttribute(x1),
      iM: x0 => x0.state,
      ...
      jI: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      ...
      uN: (x0,x1) => new OffscreenCanvas(x0,x1),
      v: (a, i) => a.push(i),
      ...
      wM: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      wN: x0 => x0.loader,
      ...
      xM: () => globalThis.Notification.requestPermission(),
