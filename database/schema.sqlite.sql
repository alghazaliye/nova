...
CREATE TABLE message_deletions (id INTEGER PRIMARY KEY AUTOINCREMENT, message_id INTEGER NOT NULL, conversation_id INTEGER NOT NULL, deleted_by INTEGER NOT NULL, original_body TEXT, original_type VARCHAR(20), scope_type VARCHAR(20) NOT NULL DEFAULT 'for_me', deleted_at DATETIME NOT NULL DEFAULT (datetime('now','localtime')));
